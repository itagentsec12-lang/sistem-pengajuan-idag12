...
export default function InputForm({ userEmail, dropdowns, onDataSubmit }) {
  ...
  const posisiOptions = [
    "ADMIN_BACKOFFICE", "PROCESSING_BACKOFFICE", "COORDINATOR_BACKOFFICE",
    "SPV", "TRANSPORTER", "SPRINTER PICKUP", "IMPLAN_PROCESSING",
    "SPRINTER_DELIVERY", "MONITORING/OWNER", "SALES/MARKETING",
